...
window.data = {
  "profile": {
    ...
    "bio": "I specialize in developing real-time simulation and training systems using Unity, focusing on the intersection of physical hardware (sensors, haptics) and software logic. My background allows me to deliver high-fidelity applications, particularly in the Medical Simulation and XR/VR space.",
  ...
  "resume": {
    "experience": [
      {
        "role": "Freelance Simulation Developer",
        "company": "Self-Employed",
        "date": "2021 - Present",
        "desc": "Developing bespoke simulation software focusing on Unity, C#, and embedded systems integration. Specialized in vehicle physics and medical training sims."
      },
      {
        "role": "Hardware Developer",
        "company": "Tech Company",
        "date": "2024",
        "desc": "Designed and prototyped embedded control systems. Validated sensor logic and managed CNC manufacturing processes for PCB prototyping."
      }
    ],
    "education": [
      {
